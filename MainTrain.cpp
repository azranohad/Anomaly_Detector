...
void generateTrainCSV(float a1,float b1, float a2, float b2, float a3, float b3){
    ...
    for(int i=1;i<=100;i++){
        ...
        float e = -1*a;
        if (i%2==0) {
            out<<a<<","<<b<<","<<ac.f(a)-0.02+(rand()%40)/100.0f<<","<<bd.f(b)-0.02+(rand()%40)/100.0f<< "," <<e <<","<< ef.f(e)-0.02+(rand()%40)/100.0f <<endl;
        }
        else {
            out<<a<<","<<b<<","<<ac.f(a)-0.02+(rand()%40)/100.0f<<","<<bd.f(b)-0.02+(rand()%40)/100.0f<< "," <<a <<","<<  ef.f(a)-0.02+(rand()%40)/100.0f <<endl;
        }
    }
    out.close();
}
...
void generateTestCSV(float a1,float b1, float a2, float b2, float a3, float b3, int anomaly){
    ...
    for(int i=1;i<=100;i++){
        ...
        if(i!=anomaly) {
            ...
            out<<a<<","<<b<<","<<ac.f(a)+1<<","<<bd.f(b)-0.02+(rand()%40)/100.0f<< "," <<e <<","<< ef.f(e)+1 <<endl;
    }
    out.close();
}
